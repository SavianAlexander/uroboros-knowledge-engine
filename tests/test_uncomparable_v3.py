"""
Self-check unit test suite for God-Tier Incomparable RAG Frontier Paradigms v3:
...
def test_graph_link_synthesizer():
...
def test_context_budget_allocator():
