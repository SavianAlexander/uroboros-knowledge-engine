# Progress Report: Uroboros Knowledge Engine Evolution (Final V16)
...
| Metric | Version 1 | Version 5 | Version 8 | Version 10 | Version 11 | Version 14 | Version 16 (Current) | Total Progress (V1 -> V16) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| **Total Lines of Code (Backend)** | ~200 | ~640 | 750 | 1136 | 1264 | 1620 | 1647 (601 know.py + 1046 main.py) | **+723%** |
| **Search Capabilities** | FTS5 Keyword | FTS5 + syntax | Query sorting | LAN P2P sync | Rollbacks + Concept graph | Highlights + Sandbox simulation | Annotation FTS matching + Semantic Score rings | **Expanded** |
| **UI Components** | None | + Dropzone | Stats card, dropdowns | progress bar | Interactive graph, inline editor | PDF layout, stats CSV export, colored nodes | Interactive drag physics nodes, semantic matching progress rings, include notes toggle | **Expanded** |
...
- **Advanced Annotations FTS Snippets**: Searches notes columns in addition to contents, highlighting matched terms dynamically inside FTS results.

### V15 to V16 (Physics Nodes Dragging & PDF Filters - Current)
- **Interactive Drag-and-Drop Concept Canvas**: Integrates mouse move and drag canvas coordinate physics listeners in the 2D concept graph. Users can click and drag nodes to manually organize networks.
- **Vector Score Radial Matching Indicators**: Renders similarity matching scores as clean radial SVG progress ring wheels directly within search listing cards.
- **Inclusion Checklist Filter for Reports Exporter**: Extends `/api/report/export` with query parameter `include_notes` and binds a results list header checkbox. Excludes notes data entirely from PDF files when toggled.
