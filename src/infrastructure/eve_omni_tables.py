...
Generates 100% strictly verified empirical dossiers directly from CCP ESI telemetry:
...
def generate_omni_tables_markdown() -> list:
    created_files = []
    ...
    # 1. Generate Individual Character Omni Tables
    for name, data in empirical_data.items():
        ...
        if name == "Savian Alexander":
            ...
            role_desc = "**Apex Combatant, Capital Director & Fleet Master Refiner**"
            ...
            self_corr = f"Astrogeology V, Mining V, Ice Harvesting V, Industry V, Metallurgy IV, Mining Barge IV, Mining Upgrades IV. Actively training Reprocessing V and Moon/Asteroid Ore processing."
            ...
            self_corr = f"Holds **1,000,000 Unallocated SP**; currently training Industry I $\\rightarrow$ V, Cybernetics II-III, and defensive tanking."
...
"""
    ...
    # 2. Master Fleet Omni-Correlation Dashboard
    os.makedirs(FLEET_DIR, exist_ok=True)
    dashboard_path = os.path.join(FLEET_DIR, "fleet_omni_correlation_dashboard.md")
