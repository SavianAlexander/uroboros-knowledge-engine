...
class TestHybridRankingComparison(unittest.TestCase):
    def test_counterfactual_rag(self):
    ...
    def test_raptor_tree_indexer(self):
        chunks = [
    ...
    def test_binary_colbert_maxsim(self):
    ...
    def test_auto_correct_grounding(self):
