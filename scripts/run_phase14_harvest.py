...
from src.infrastructure.eve_anomalies_capitals import generate_anomalies_capitals_markdown
from batch_index import index_single_file
from src.infrastructure.database import run_maintenance

print("=================================================================")
print("🌐 STARTING PHASE 14: CAPITAL WARFARE, JUMP DRIVES & ANOMALIES")
print("=================================================================")

start_time = time.time()
indexed_count = 0

print("\n🚀 Generating Sovereign Anomalies, Capital Warfare, Jump Drives & Crimewatch...")
cap_files = generate_anomalies_capitals_markdown()
for f in cap_files:
    index_single_file(f)
    indexed_count += 1
...
print("=================================================================")
print(f"🎉 PHASE 14 INTEGRATION COMPLETE in {elapsed:.2f}s!")
