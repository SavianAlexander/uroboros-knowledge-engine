import{b as S,j as e}from"../app.js";import{r as o,av as C,aa as f,af as v,k as p,i as u,az as R,f as g,C as N,z as A,E as k,p as T,Z as w}from"./vendor-icons.js";import"./vendor-graph.js";const i=[{id:"tri-engine",title:"Tri-Engine Orchestration",subtitle:"Neuro Vector Vault + Tududi Task Master + GitHub Merkle Engine",category:"TRI_ENGINE",icon:C,badge:"TRI-ENGINE",badgeColor:"emerald",description:"Synchronized tripartite execution loop binding local semantic intelligence, autonomous project task orchestration, and cryptographic git commit provenance.",keyMetrics:[{label:"Throughput",value:"43 Ops/Sec"},{label:"Provenance",value:"SHA-256 Merkle"},{label:"Task Sync",value:"Tududi #13"},{label:"Isolation",value:"Air-Gapped"}],mermaidCode:`graph TB
