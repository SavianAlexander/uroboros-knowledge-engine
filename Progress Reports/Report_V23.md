# Progress Report: Uroboros Knowledge Engine Evolution (Final V23)
...
| Metric | Version 1 | Version 10 | Version 18 | Version 20 | Version 21 | Version 22 | Version 23 (Current) | Total Progress (V1 -> V23) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Total Python Files** | 2 | 3 | 3 | 3 | 3 | 3 | 3 | **+50%** |
| **Total HTML/JS/CSS Files** | 0 | 3 | 3 | 3 | 3 | 3 | 3 | **+3 files** |
| **Supported File Formats** | 12 | 22 | 24 | 24 | 24 | 24 | 24 | **+100%** |
| **Total Lines of Code (Backend)** | ~200 | 1136 | 1695 | 1821 | 1944 | 2005 | 2132 (649 know.py + 1483 main.py) | **+966%** |
| **Search Capabilities** | FTS5 Keyword | LAN P2P sync | FTS5 audio metadata searches | Custom word boundaries FTS snippet limits | Query Macros (%macro%) & Tag Aliases | SQLite FTS5 NEAR proximity operators | Synonym lookups mapping (`OR` expansion) | **Expanded** |
| **UI Components** | None | progress bar | envelopes, TOC PDF dropdown | Bulk delete checkboxes, custom tag colors | Query Macro selector, Folder Scope breadcrumbs | Selectable Concept Graph layout presets, Priority rules inputs | Synonym entries, automated backup scheduler settings, HTML inline iframe render preview | **Expanded** |
...
### V22 to V23 (FTS Synonym Mapping, Automated DB Backup Schedules & HTML Document Preview Support - Current)
...
- **IFrame HTML Document Render**: Automatically embeds `.html` previews inside iframes when selected inside the preview panel drawer.
