---
title: Repository File Naming & Architectural Topology Standard
category: System Architecture
tags: [Standard, FileNaming, CleanArchitecture, Python, TestSuite, Scripts, Vault]
last_updated: 2026-08-15
---

# Repository File Naming & Architecture Standard

This standard establishes the canonical directory structure and naming conventions across the entire repository.
...
1. **No Transient Phase Naming (`phaseXX`, `milestone_mX`, `sota_phaseX`)**: 
   - Files must not be named after transient development phases, tickets, or iterations.
...
4. **Standard Test Topology (`tests/`)**:
   - Unit & Domain Tests: `tests/test_<domain>_<capability>.py` (e.g., `tests/test_domain_chat_intelligence.py`, `tests/test_voice_synthesis_audio_processing.py`).
...
5. **Standard Source Architecture (`src/`)**:
   ...
   - `src/domain/`: Domain algorithms, AST extractors, wikilink graphs, and RAG pipelines.
