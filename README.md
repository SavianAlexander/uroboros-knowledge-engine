...
## 5. Operations & Benchmark Utility Scripts (`scripts/`)
...
## 6. SQLite Database DDL & Storage Schema
...
### 7.1 Hybrid Search API (`GET /api/search`)
...
### 7.2 Conversational RAG Assistant (`POST /api/rag/query`)
- **Request Body**:
```json
{
...
### 7.3 Daily Executive Briefing (`GET /api/briefing/daily`)
- **Response 200 OK**:
```json
{
  "status": "success",
...
## 8. Infrastructure Core Subsystems

### 8.1 SQLite Thread Connection Pool ([`database.py`](file:///c:/Users/Administrator/Desktop/Neuro%20Alexander/src/infrastructure/database.py))
...
### 8.2 Real-Time Directory Watcher ([`watcher.py`](file:///c:/Users/Administrator/Desktop/Neuro%20Alexander/src/infrastructure/watcher.py))
...
### 8.3 Peer-to-Peer LAN Synchronization ([`p2p_sync.py`](file:///c:/Users/Administrator/Desktop/Neuro%20Alexander/src/infrastructure/p2p_sync.py))
...
## 9. Configuration Parameters & Environment Variables
...
## 10. CLI Command Reference & Operations
...
## 11. Frontend Architecture & React SPA Views
...
## 12. Quality Assurance & Compliance Attestation
...
### 12.1 Engineering Test Protocols
