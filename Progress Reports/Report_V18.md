# Progress Report: Uroboros Knowledge Engine Evolution (Final V18)
...
| Metric | Version 1 | Version 5 | Version 8 | Version 10 | Version 11 | Version 14 | Version 18 (Current) | Total Progress (V1 -> V18) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| **Total Lines of Code (Backend)** | ~200 | ~640 | 750 | 1136 | 1264 | 1620 | 1695 (605 know.py + 1090 main.py) | **+747%** |
| **Search Capabilities** | FTS5 Keyword | FTS5 + syntax | Query sorting | LAN P2P sync | Rollbacks + Concept graph | Highlights + Sandbox simulation | FTS5 audio metadata searches + Semantic matching | **Expanded** |
| **UI Components** | None | + Dropzone | Stats card, dropdowns | progress bar | Interactive graph, inline editor | PDF templates, CSV stats | Canvas node clusters visual envelopes, TOC PDF layout selector dropdown | **Expanded** |
...
### V17 to V18 (Automatic Node Grouping & Hierarchical TOC PDF Reports - Current)
...
- **Audio Attributes FTS5 Indexing**: Updates WAV/MP3 indexing scripts inside `know.py` to write metadata attributes (sample rate, channels, bitrates) directly to database files. Users can search audio formats using query constraints.
