...
""".replace("__TIMESTAMP__", ts)
    ...
    def harvest_universe_regions_spec(self) -> Dict[str, Any]:
        """Harvest unredacted 114 EVE Online Universe Regions specification."""
        filename = "eve_universe_114_regions_and_systems_catalog.md"
        filepath = os.path.join(self.output_dir, filename)
        ts = time.strftime('%Y-%m-%dT%H:%M:%SZ', time.gmtime())

        content = f"""---
title: "CCP Games Official EVE Online Universe 114 Regions Topology Specification"
source_authority: "CCP Games Map & Universe Topology SDE"
spec_version: "SDE Universe Topology 2026.1"
harvested_at: "{ts}"
document_status: "OFFICIAL_PRIMARY_SOURCE_UNABRIDGED"
verification: "CCP_REGIONS_SPEC_VERIFIED"
---

# EVE Online Universe 114 Regions Master Topology

## 1. Empire & Nullsec Master Regions
- Domain (ID: 10000043) - Amarr Prime
- The Forge (ID: 10000002) - Jita IV-4
- Sinq Laison (ID: 10000032) - Dodixie IX-20
- Metropolis (ID: 10000042) - Hek VIII-12
- Heimatar (ID: 10000030) - Rens VI-8
- Delve (ID: 10000060)
- Fountain (ID: 10000058)
- Providence (ID: 10000047)
- Catch (ID: 10000014)
- Deklein (ID: 10000035)
"""
        sha256 = hashlib.sha256(content.encode("utf-8")).hexdigest()
    ...
    def harvest_all(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            self.harvest_universe_regions_spec(),
        ]
