# Progress Report: Uroboros Knowledge Engine Evolution (Final V21)
...
| Metric | Version 1 | Version 10 | Version 15 | Version 18 | Version 19 | Version 20 | Version 21 (Current) | Total Progress (V1 -> V21) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| **Total Lines of Code (Backend)** | ~200 | 1136 | ~1500 | 1695 | 1756 | 1821 | 1944 (629 know.py + 1315 main.py) | **+872%** |
| **Search Capabilities** | FTS5 Keyword | LAN P2P sync | Advanced FTS | FTS5 audio metadata searches | Search exclusions operators | Custom word boundaries FTS snippet limits | Query Macros (%macro%) & Tag Aliases | **Expanded** |
| **UI Components** | None | progress bar | Graph focus selection | envelopes, TOC PDF dropdown | Scaled OCR highlights canvas overlay | Bulk delete checkboxes, custom tag colors | Query Macro selector, Folder Scope breadcrumbs | **Expanded** |
...
### V20 to V21 (Query Macros, Directory PDF Exporters & Tag Aliases - Current)
