...
function drawGraph(nodes, links) {
    ...
    window.setGraphNeedsRedraw = () => { needsRedraw = true; };
    ...
    // Interactive mouse gesture handlers with hover detection and node drag/pan
    ...
    // Touch gesture handlers for mobile viewports & touch responsiveness
    ...
    function draw() {
        ...
        // Draw Nodes with smooth scale, hover glow, and shadow transitions
        nodes.forEach(n => {
            ...
            ctx.save();
            ctx.fillStyle = color;
            ctx.globalAlpha = isFilterDimmed ? 0.1 : ((selectedNodeId && !isConnected) ? 0.2 : 1.0);
