...
from src.infrastructure.eve_fleet_capabilities import generate_fleet_capabilities_markdown
from batch_index import index_single_file
from src.infrastructure.database import run_maintenance

print("=================================================================")
print("🌐 STARTING PHASE 9: FLEET CAPABILITIES, MULTI-BOXING & TRACKER")
print("=================================================================")

start_time = time.time()
indexed_count = 0

print("\n🚀 Generating Fleet Role Synergies, ISK Simulations & 48-Planet PI Empire...")
cap_files = generate_fleet_capabilities_markdown()
for f in cap_files:
    index_single_file(f)
    indexed_count += 1
...
print("=================================================================")
print(f"🎉 PHASE 9 INTEGRATION COMPLETE in {elapsed:.2f}s!")
