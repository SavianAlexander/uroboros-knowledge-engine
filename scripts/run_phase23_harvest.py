...
from src.infrastructure.eve_palantir_fusion import generate_palantir_fusion_markdown
from batch_index import index_single_file
from src.infrastructure.database import run_maintenance

print("=================================================================")
print("🌐 STARTING PHASE 23: PALANTIR DEFENSE & INTELLIGENCE FUSION")
print("=================================================================")

start_time = time.time()
indexed_count = 0

print("\n🚀 Synthesizing Palantir Multi-Source Defense & Intelligence Archives...")
pal_files = generate_palantir_fusion_markdown()
for f in pal_files:
    index_single_file(f)
    indexed_count += 1
...
print("=================================================================")
print(f"🎉 PHASE 23 INTEGRATION COMPLETE in {elapsed:.2f}s!")
