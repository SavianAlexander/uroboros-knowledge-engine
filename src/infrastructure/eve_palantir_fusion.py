"""
EVE Online Palantir Defense & Multi-Source Intelligence Fusion Engine.

Synthesizes Palantir Foundry / Gotham style intelligence archives for New Eden:
...
PALANTIR_DIR = os.path.join(VAULT_EVE_DIR, "Palantir_Intelligence")


def generate_palantir_fusion_markdown() -> list:
    os.makedirs(PALANTIR_DIR, exist_ok=True)
    created_files = []

    # 1. COALITION GEOPOLITICAL GRAPH
    f1 = os.path.join(PALANTIR_DIR, "coalition_geopolitical_graph.md")
    m1 = """# Palantir Intelligence: Global Coalition Geopolitical Graph & Sovereign Super-Grids

Multi-dimensional intelligence mapping global sovereign alliances, supercapital umbrellas, and territorial boundaries.
...
graph TD
    ...
    Snuff["☠️ SNUFFED OUT (Lowsec Supercapital Powerbloc)<br>Black Rise • Placid • Lonetrek • Citadel Drops"]
...
"""
    ...
    f2 = os.path.join(PALANTIR_DIR, "threat_fusion_gank_cyno_radar.md")
    m2 = """# Palantir Intelligence: Multi-Source Threat Fusion & Cyno/Gank Squad Radar
...
"""
    ...
    f3 = os.path.join(PALANTIR_DIR, "mer_macroeconomics_mineral_flows.md")
    m3 = """# Palantir Intelligence: Monthly Economic Report (MER) Macroeconomics & Mineral Flows
...
"""
    ...
    f4 = os.path.join(PALANTIR_DIR, "citadel_timers_timezone_defense.md")
    m4 = """# Palantir Intelligence: Citadel & Sovereignty Reinforcement Timer Defense Matrix
